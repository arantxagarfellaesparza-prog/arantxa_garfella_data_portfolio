...
| 02 | [Credit Risk Prediction Engine](projects/02-credit-risk) | Can historical origination-time data predict lifetime charge-off risk for future loans, with probabilities that stay calibrated as populations and policy drift? | Target/leakage auditing, temporal validation, calibration vs discrimination, point-in-time macro | **M0 closed** |
...
📍 **Currently:** Project 01 complete. Project 02 past M0 — modelling population frozen, no model trained yet. See [docs/roadmap.md](docs/roadmap.md).
